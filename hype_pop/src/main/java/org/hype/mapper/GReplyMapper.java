...
public interface GReplyMapper {
	...
	public List<gReplyVO> getAllReplyListWithPaging(@Param("gno") int gno, @Param("userNo") int userNo,
	...
	public List<gReplyVO> getUserRepliesWithPaging(@Param("userNo") int userNo, @Param("startRow") int startRow,
