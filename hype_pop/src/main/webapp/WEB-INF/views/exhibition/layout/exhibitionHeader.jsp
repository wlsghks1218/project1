...
#exhibitionSearchBox {
    ...
    flex-grow: 1;
    margin: 0 20px;
    transform: translateX(-60px); /* 왼쪽으로 60px 이동 */
}
...
<body>
	...
	<div class="popUpHeader">
		...
		<div id="exhibitionSearchBox">
			<input type="text" id="exhibitionSearchInput" placeholder="검색어 입력">
			<div id="exhibitionSearchClick">
				<span id="searchBTN" onclick="applyFilter()">검색</span>
			</div>
		</div>
		<div id="alarmDiv" style="position: relative;">
			<img src="/resources/images/alarm.png" alt="알림" id="alarmImage"
				style="cursor: pointer; max-height: 35px; width: auto;"
				onclick="handleAlarmClick()"> <span id="notificationDot"
				class="notification-dot"
				style="display: none; position: absolute; top: 0; right: 0; width: 10px; height: 10px; background-color: red; border-radius: 50%;"></span>
		</div>
